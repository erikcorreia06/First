    ...
    public class UsuarioController : ControllerBase
    {
        ...
        public IActionResult AddUsuario([FromBody]CreateUsuarioDto  usuarioDto)
        {
            ...
            catch (Exception)
            {
                ...
                return StatusCode(500, "Ocorreu um erro ao adicionar o usuário."); // verificar metodo que ao tomar qualquer status code 500 retornar erro generico
            }
        }

        [HttpPut("{id}")]  // put atualiza a entidade inteira e patch apenas um pedaço 
        ...
        public IActionResult DeleteUsuario(int id)
        {
            ...
            {
                _unitOfWork.Rollback();
                return StatusCode(500, "Ocorreu um erro ao excluir o usuário."); // como tratar de uma maneira melhor uma exception ( adicionando logs e tratando as mesmas ) 
            }
        }
    }
}
